...
namespace RiseTech\Monitoring\Watchers;
...
use RiseTech\Monitoring\Services\ExtractProperties;
use RiseTech\Monitoring\Traits\FormatsClosure\FormatsClosure;
    ...
    protected function formatListeners($eventName): array
    {
        return collect(app('events')->getListeners($eventName))
            ->map(function ($listener) {
                ...
                return Str::contains($listener, 'RiseTech\\Monitoring');
            })->map(function ($listener) {
